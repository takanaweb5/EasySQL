...
'*****************************************************************************
'[ 概  要 ]　選択されたセルを元にSELECT文のひな形を作成する
'[ 引  数 ]　なし
'[ 戻り値 ]　なし
'*****************************************************************************
Public Sub MakeSQL()
...
'*****************************************************************************
'[ 概  要 ]　フォームを表示してセルを選択させる
'[ 引  数 ]　strMsg：表示するメッセージ、objCurrentCell：初期選択させるセル
'[ 戻り値 ]　選択されたセル（キャンセル時はNothing）
'*****************************************************************************
...
'*****************************************************************************
'[ 概  要 ]　strAddressがCellを指すアドレスかどうか
'[ 引  数 ]　チェック対象の、アドレスを示すはずの文字列
'[ 戻り値 ]　Boolean
'*****************************************************************************
...
'*****************************************************************************
'[ 概  要 ]　SQLの選択されたセルの値を取得する
'[ 引  数 ]　SQLの入力させたRange
'[ 戻り値 ]　セルの値（複数行の時：値が初期値でないセルの値を改行で連結）
...
'*****************************************************************************
'[ 概  要 ]　SQLの結果を2次元配列で取得する
'[ 引  数 ]　SQLの入力されたセル、Dummy():再計算のトリガーにしたいセルがあれば設定する
'[ 戻り値 ]　実行結果(2次元配列)※セル関数で配列数式形式(Ctrl+Shift+Enter)で取り出す
'*****************************************************************************
...
'*****************************************************************************
'[ 概  要 ]　セル関数用のTextJoinもどき
'[ 引  数 ]　両端文字:例："'"→'テキスト'、""""→"テキスト"、"[]"→[テキスト]
'　　　　　　区切り文字:区切り文字（","等）、
'　　　　　　連結セル():連結する Range
'[ 戻り値 ]　連結後の文字列
'*****************************************************************************
